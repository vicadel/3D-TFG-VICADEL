...
// myservo1 to myservo5 are for the fingers
...
{ 
  ...
  myservo1.attach(D2);    // Attach the first servomotor to pin D2 (26)
  myservo2.attach(D3);    // Attach the second servomotor to pin D3 (25)
  myservo3.attach(D4);    // Attach the third servomotor to pin D4 (17)
  myservo4.attach(D5);    // Attach the fourth servomotor to pin D5 (16)
  myservo5.attach(D6);    // Attach the fifth servomotor to pin D6 (27)
  //myservo6.attach(D7);  // Attach the sixth servomotor to pin D7 (14), commented out
} 
...
{ 
  ...
  {                          
    myservo1.write(180 - angle);  // Move the first servo to the position 180 - angle, a temporary adjustment to fix the servo's reverse direction
  ...
  {                                
    myservo1.write(180 - angle);  // Move the first servo to the position 180 - angle
    myservo2.write(angle);        // Move the second servo to the position angle
    myservo3.write(angle);        // Move the third servo to the position angle
    myservo4.write(angle);        // Move the fourth servo to the position angle
    myservo5.write(angle);        // Move the fifth servo to the position angle
