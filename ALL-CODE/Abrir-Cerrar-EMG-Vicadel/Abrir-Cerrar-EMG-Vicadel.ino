...
#define THRESHOLD 14 //In order to determine the state of the hand (opened/closed)
#define EMGPIN     A2 //Analog pin connected to Muscle Sensor V3 Board
#define LITTLEPIN  D2 //Digital pin used by Little servo
#define RINGPIN    D3 //Digital pin used by Ring servo
#define MIDDLEPIN  D4 //Digital pin used by Middle servo
#define INDEXPIN   D5 //Digital pin used by Index servo
#define THUMBPIN  D6 //Digital pin used by Thumb servo
...
void openFinger(int finger){
  ...
  else if(finger==RING){servoRingFinger.write(180);}// Ring finger
  else if(finger==MIDDLE){servoMiddleFinger.write(180);}// Middle finger   //170
  else if(finger==INDEX){servoIndexFinger.write(180);}// Index finger
  else if(finger==THUMB){servoThumbFinger.write(0);}//Thumb finger
}

void closeFinger(int finger){
  if(finger==LITTLE){servoLittleFinger.write(180);} // Little finger 
  ...
  else if(finger==THUMB){servoThumbFinger.write(180);}//Thumb finger        //170
}
...
void setup(){
  ...
  //puerto serie me comunico a 9600 baudios mirar lectura, mirar paraemtros por defecto del programa, 
